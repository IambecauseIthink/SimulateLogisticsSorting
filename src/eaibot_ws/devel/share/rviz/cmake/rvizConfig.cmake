...
if("TRUE" STREQUAL "TRUE")
  set(rviz_SOURCE_PREFIX /home/eaibot/eaibot_ws/src/dashgo/rviz/rviz-kinetic-devel)
  set(rviz_DEVEL_PREFIX /home/eaibot/eaibot_ws/devel)
  set(rviz_INSTALL_PREFIX "")
  set(rviz_PREFIX ${rviz_DEVEL_PREFIX})
else()
  set(rviz_SOURCE_PREFIX "")
  set(rviz_DEVEL_PREFIX "")
  set(rviz_INSTALL_PREFIX /home/eaibot/eaibot_ws/install)
...
if(NOT "/home/eaibot/eaibot_ws/src/dashgo/rviz/rviz-kinetic-devel/src;/usr/include/eigen3;/usr/include/OGRE/Overlay;/usr/include/OGRE;/usr/include " STREQUAL " ")
  set(rviz_INCLUDE_DIRS "")
  set(_include_dirs "/home/eaibot/eaibot_ws/src/dashgo/rviz/rviz-kinetic-devel/src;/usr/include/eigen3;/usr/include/OGRE/Overlay;/usr/include/OGRE;/usr/include")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'rviz' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/eaibot/eaibot_ws/src/dashgo/rviz/rviz-kinetic-devel/${idir}'.  ${_report}")
    endif()
